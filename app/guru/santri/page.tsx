...
export default function KelolaSantri() {
  ...
  // ==========================================
  // FITUR SUPER: NAIK KELAS OTOMATIS (KHUSUS UI SEMENTARA)
  // ==========================================
  ...
  // ==========================================
  // FITUR CRUD MANUAL (TERHUBUNG DATABASE)
  // ==========================================
  const handleSave = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/santri', {
        ...
        body: JSON.stringify(currentSantri)
      });
                ...
                {isLoading ? (
                  <tr>
                    <td colSpan={6} className="p-12 text-center">
                      ...
                      <p className="text-slate-500 font-bold">Mengambil data dari Database...</p>
                    </td>
                  </tr>
